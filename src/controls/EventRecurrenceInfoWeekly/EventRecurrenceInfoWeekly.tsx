...
import  './EventRecurrenceInfoWeekly.module.scss';
          ...
          <div>
            ...
            <div style={{ width: '100%', paddingTop: '10px' }}>
              ...
              <div style={{ marginTop: '10px' }}>
                <Checkbox label="Sunday" className={"ckeckBoxInline"} checked={this.state.weeklySunday} onChange={this.onCheckboxSundayChange} />
                <Checkbox label="Monday" className={"ckeckBoxInline"} checked={this.state.weeklyMonday} onChange={this.onCheckboxMondayChange} />
                <Checkbox label="Tuesday" className={"ckeckBoxInline"} checked={this.state.weekklyTuesday} onChange={this.onCheckboxTuesdayChange} />
                <Checkbox label="Wednesday" className={"ckeckBoxInline"} checked={this.state.weekklyWednesday} onChange={this.onCheckboxWednesdayChange} />
              </div>
              <div style={{ marginTop: '10px' }}>
                <Checkbox label="Thursday" className={"ckeckBoxInline"} checked={this.state.weekklyThursday} onChange={this.onCheckboxThursdayChange} />
                <Checkbox label="Friday" className={"ckeckBoxInline"} checked={this.state.weeklyFriday} onChange={this.onCheckboxFridayChange} />
                <Checkbox label="Saturday" className={"ckeckBoxInline"} checked={this.state.weeklySaturday} onChange={this.onCheckboxSaturdayChange} />
              </div>
            </div>
